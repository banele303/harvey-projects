...
const features = [
  ...
  },
  {
    ...
    description:
      "We are always pantual with our time , we always constistent with our Profetion",
  },
  {
    icon: "/icons/scalable.svg",
    title: "Scalability + Maintenance ",
    description: "We offer maintenance and scalability for all the services that we offer",
  },
  {
    icon: "/icons/team.svg",
